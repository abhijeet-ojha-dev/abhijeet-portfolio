...
This portfolio website is designed to showcase professional expertise as a Salesforce Developer with 3+ years of experience. It features:
...
4. **👤 About Section**
   ...
   - Clean image-only profile presentation with subtle animation
...
5. **💼 Experience & Education Timeline**
   ...
   - Company logo panels in experience cards (IDRMS + WarpDrive)
...
7. **🏆 Certifications Section**
   ...
   - Tap-safe touch handling to prevent accidental modal open during scroll
...
8. **📧 Contact Section**
   ...
   - Two-column tablet layout (info + form), stacked on mobile
...
│   │   ├── hero_avatar.png     # About section image
│   │   ├── IDRMS_logo.jpg      # IDRMS timeline logo
│   │   └── warpdrive_logo.png  # WarpDrive timeline logo
│   │
│   └── documents/
...
- **Profile Image:** Secondary profile with clean image-only presentation
- **Statistics Cards:**
...
- Image presented without decorative overlay box
...
- **Timeline Items:**
  1. **Salesforce Developer** at IDRMS Technology (2026 - Present)
  2. **Salesforce Developer** at WarpDrive Tech Works (2023 - 2026)
  3. **Fullstack Web Development** at Masai School (2022 - 2023)
  4. **B.Tech CSE** at GIET (2016 - 2020)
- **Interactive Modals:** "Know More" buttons open detailed modals
- **Animated Badges:** Different icons for experience vs education
- **Branding:** Experience cards include right-side company logo panels on all screen sizes
...
- Responsive repositioning with tuned logo-card behavior for mobile/tablet
...
- Tap-safe touch-end guards to ignore scroll gestures on mobile
...
**Technical Details:**
- Grid layout with two-column tablet layout and stacked mobile layout
...
**Features:**
- **Copyright Notice:** © 2026 Abhijeet
...
1. **CV/Resume:**
   - Replace `assets/documents/abhijeet-ojha-salesforce-dev-2026.pdf`
...
- **Contact:** Two-column on tablet, stacked on mobile
- **Typography:** Fluid font sizes with clamp()
- **Experience Cards:** Logo-aware layout that adapts without overlap
...
**5. Certificate popup opens while scrolling on mobile:**
- Ensure `assets/js/script.js` includes tap-safe touch handlers
- Confirm `TAP_MAX_MOVEMENT` is configured in `CAROUSEL_CONFIG`
- Hard refresh browser after JavaScript updates
...
- **HTML:** ~1,259 lines
- **CSS:** ~5,387 lines (`styles.css` + `responsive.css`)
